...
@Component
public class ScrapeNewsByGigazine extends ScrapingNews {
    private static final String SOURCE_BY = "gigazine";
    private static final String SOURCE_URL = "https://gigazine.net";

    public ScrapeNewsByGigazine(SummarizeNews summarizeNews) {
        super(summarizeNews);
    }
    ...
    public Elements getDomElements() throws IOException {
        ...
        return doc.select("#section > div > section > div.card");
    }
